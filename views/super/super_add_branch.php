    ...
    <div class="card">
      <div class="card-body">
        ...
        <form class="row g-3" id="add_data">
          ...
          <div class="col-md-6">
            <input type="text" class="form-control" id="code" name="code" placeholder="<?php echo $lang['code']; ?>">
          </div>
          <div class="col-md-11">
          ...
          <div class="col-md-1 col-sm-12">
            <input type="color" class="form-control form-control-color" name="color" id="color" value="#2f35a6"
              placeholder="<?php echo $lang['color']; ?>" title="<?php echo $lang['choose_color']; ?>">
          </div>

          <div class="text-end">
            <button type="button" class="btn btn-secondary"
              onclick="window.location.href='super_view_branch.php'">Branch List</button>
