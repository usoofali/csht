...
<head>
  ...
  <title>Pages / Reset - Community School</title>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="post" novalidate>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" name="reset" type="submit">Reset</button>
                    </div>
                    <div class="col-12">
                      <p class="small mb-0">Go back <a href="pages-reset.php">Home</a></p>
                    </div>
                  </form>
                  <div>
                      <?php
              ...
              <div class="credits">
                Designed by <a href="https://csht.com/">CSHT GUSAU</a>
              </div>
